...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--name', type=str, default="04090263-notxt", help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        parser.add_argument('--summary_dir', type=str, default='./runs', help='tensorboard logs are saved here')
        parser.add_argument('--seed', type=int, default=0)
        parser.add_argument('--class_id', type=str, default=["04090263"])
