...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--vis_freq', type=int, default=200, help='training visualization frequency, in steps')
        parser.add_argument('--val_epoch_freq', type=int, default=100, help='validation frequency, in epochs')
        parser.add_argument('--val_epoch_vis_n', type=int, default=20, help='number of data to visualize in validation')
        parser.add_argument('--test_epoch_freq', type=int, default=500, help='testing frequency, in epochs')
